      ...
      activityItems: [
        {
          ...
          body: "West Kelowna Townhomes Phase 2 (Gellatly Homes) flipped from In Review to Issued. Framing and mechanical subs get locked in fast on townhome builds.",
          oppId: "opp-5",
          companyName: "Gellatly Homes",
          phone: "250-555-0188",
        ...
        },
        {
          ...
          status: "pending",
          priority: "high",
          title: "Follow up with Skyline Developments",
          body: "You reached out 7 days ago about Kelowna Mixed-Use Development. No update logged — worth a quick check-in?",
          oppId: "opp-1",
